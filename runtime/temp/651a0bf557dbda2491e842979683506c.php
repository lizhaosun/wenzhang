<?php /*a:4:{s:82:"D:\myphp_www\PHPTutorial\WWW\think\application\admin\view\article\articleList.html";i:1553575488;s:76:"D:\myphp_www\PHPTutorial\WWW\think\application\admin\view\public\layout.html";i:1550909985;s:73:"D:\myphp_www\PHPTutorial\WWW\think\application\admin\view\public\nav.html";i:1550682140;s:74:"D:\myphp_www\PHPTutorial\WWW\think\application\admin\view\public\left.html";i:1550915962;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<table class="table table-default table-hover text-center">
    ...
    <?php if(is_array($artList) || $artList instanceof \think\Collection || $artList instanceof \think\Paginator): $i = 0; $__LIST__ = $artList;if( count($__LIST__)==0 ) : echo "$empty" ;else: foreach($__LIST__ as $key=>$article): $mod = ($i % 2 );++$i;?><!--//遍历-->
    <tr>
        <td><?php echo htmlentities($article['id']); ?></td>
        <td><?php echo htmlentities($article['title']); ?></td>
        <td><?php echo htmlentities(getCateName($article['cate_id'])); ?></td>
        <?php if(app('session')->get('admin_level') == '1'): ?>
        <td><?php echo htmlentities(getUserName($article['user_id'])); ?></td>
        <?php endif; ?>
        ...
        <td><a href="<!--javascript:;-->" onclick="dele(<?php echo htmlentities($article['id']); ?>);return false">删除</a></td>
    </tr>
